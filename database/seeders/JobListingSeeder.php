        ...
        foreach ($employers as $employer) {
            for ($i = 0; $i < 3; $i++) {
                ...
                JobListing::create([
                    ...
                    'required_skills' => json_encode($skills[$count % count($skills)]),
                    'nice_to_have_skills' => json_encode(['Communication', 'Team Player', 'Problem Solver']),
                    'tags' => json_encode(['tech', 'hiring', 'remote']),
